...
$sub_folder = 'itc250-sp19/';//If app installed in subfolder, place here.  name of folder, no leading or trailing forward or backslash
...
define('SUPPORT_EMAIL', 'davidnguyen234@gmail.com'); # Email of site support
